...
export function normalizeContactsState(
  input: Partial<ContactsState> | null | undefined
): ContactsState {
  ...
  return {
    ...
    eventOccurrences: Array.isArray(input?.eventOccurrences)
      ? input.eventOccurrences
      : defaults.eventOccurrences,
